...
<section class="section">
    <div class="container">
        <div class="columns">
            <div class="column">
                <p class="title has-text-centered">Restaurantes que hoy ofrecen... "nombre del plato"</p>
            </div>
        </div>    
                ...
                <div class="box">
                    <div class="columns is-vcentered">
                        <div class="column is-three-fifths">
                            <h1 class="title is-4">Nombre del Restaurante 1 </h1>
                        ...
                        <div class="column">
                            <div class="has-text-centered">
                                <a class="button is-info">Como Llegar</a>
                            </div>
                        </div>
                    </div>    
                </div>
        ...
        <div class="columns is-centered">
            <div class="column is-four-fifths">
                <div class="box">
                    <div class="columns is-vcentered">
                        <div class="column is-three-fifths">
                            <h1 class="title is-4">Nombre del Restaurante 2 </h1>
                            <p class="subtitle is-6">Delicioso "nombre del plato" bañando en salsa de XXX acompañado de papitas chips, con salsa de ajo</p>
                        </div>
                        <div class="column">
                            <div>
