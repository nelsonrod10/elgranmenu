...
<div id="eliminar-sector" class="modal">
    <div class="modal-background"></div>
    <div class="modal-card">
        <header class="modal-card-head">
          <p class="modal-card-title">Eliminar Sector</p>
          <button class="delete" aria-label="close" onclick="$('#eliminar-sector').removeClass('is-active')"></button>
        </header>
        <form name="eliminar-sector" method="post" action="route('sectores.destory',$sectores)">
            @csrf
            @method('DELETE')
            <section class="modal-card-body">
            ...
            <footer class="modal-card-foot">
                ...
                <a class="button" onclick="$('#eliminar-sector').removeClass('is-active')">Cancel</a>
            </footer>
        </form>      
    </div>
</div>
