<template>
    <div class="modal is-active">
        ...
        <div class="modal-card">
            ...
            <form name="crear-sector" method="post" v-on:submit.prevent="EditarSector">
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                ...
                datosFrm:{
                    ...
                    limite1  :this.sector.limite_1,
                    limite2  :this.sector.limite_2,
                    limite3  :this.sector.limite_3,
                    limite4  :this.sector.limite_4,
                    direccion:this.sector.direccion,
                },
                flagPerimetro : false,
                flagDireccion : false,
            }
        ...
        methods:{
            ...
            EditarSector(){
                axios.put(`sectores/${this.sector.id}`,{
